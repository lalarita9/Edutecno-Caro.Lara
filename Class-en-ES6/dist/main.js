...
console.log("Impuesto: ".concat(nombreUsuario.calculoIva(valorIva.monto_bruto_anual, valorIva.deducciones)));
...
console.log("Impuesto: ".concat(nombreUsuario1.calculoIva(valorIva1.monto_bruto_anual, valorIva1.deducciones)));